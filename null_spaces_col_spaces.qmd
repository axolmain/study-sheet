...
Let \( A = \begin{pmatrix} 1 & 2 \\ 3 & 6 \end{pmatrix} \).
...
x_1 + 2x_2 = 0.
\]
Thus, \( x_1 = -2x_2 \), so any solution is a scalar multiple of \( \begin{pmatrix} -2 \\ 1 \end{pmatrix} \). The null space is therefore:
\[
...
\]
Since the second column is a scalar multiple of the first, the column space is just the span of \( \begin{pmatrix} 1 \\ 3 \end{pmatrix} \).
